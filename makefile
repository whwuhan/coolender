...
#目标文件
obj/main.o : main.cpp
	$(CC) $(FLAGS) -I$(INCLUDE_DIR) -I$(3RD_SRC) -c main.cpp -o $@

obj/camera.o : include/camera.h src/camera.cpp
	$(CC) $(FLAGS) -I$(INCLUDE_DIR) -I$(3RD_SRC) -c $(SRC_DIR)/camera.cpp -o $@

obj/mesh.o : include/mesh.h src/mesh.cpp
	$(CC) $(FLAGS) -I$(INCLUDE_DIR) -I$(3RD_SRC) -c $(SRC_DIR)/mesh.cpp -o $@

obj/model.o : include/model.h src/model.cpp
	$(CC) $(FLAGS) -I$(INCLUDE_DIR) -I$(3RD_SRC) -c $(SRC_DIR)/model.cpp -o $@
