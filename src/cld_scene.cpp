...
unsigned int Scene::shadowMappingScale = 1;//shadow mapping的缩放大小
...
Light Scene::parallelLight(vec3(10.0f, 10.0f, 0.0f), vec4(1.0f, 1.0f, 1.0f, 1.0f), vec3(-1.0f, -1.0f, 0.0f));//场景平行光
